...
"""kibana Role mapping Ansible module."""
...
short_description: This module allow to manage spaces of a Kibana installation
...
description: This module allow to manage spaces of a Kibana installation
options:
    roles:
        description:
...
class BartokITkibanaRoleMapping(BartokITAnsibleModule):
    ...
    def delete_key(self, key, current_value):
        ...
        self.__km.delete_role_mapping(key)

    def create_key(self, key, value):
        """Add a role mapping"""
        self.__km.put_space(key, **value)
    ...
    def list_current_keys(self, input_keys):
        """Return the list of spacese actually present."""
        spaces = self.__km.get_spaces(False)
        return spaces


def main():
    """Run module execution."""
    BartokITkibanaRoleMapping(argument_spec=module_args).run()
